...
import { requestDirections, requestRoutes, requestStopInformation } from "../api";
...
export default function Information() {
    ...
    useEffect(() => {
        ...
        requestStopInformation(params.routeId, params.directionId, params.stopId).then((information) => {
